...
import { CHECKLIST_BASE, OPCIONES } from "../../data/checklist.js";

export default function PasoChecklist({ respuestas, onResponder }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 11 }}>
      {CHECKLIST_BASE.map(([codigo, texto], i) => (
        <div
          key={codigo}
          className="pop-in"
          style={{
          ...
          <div style={{ display: "flex", gap: 7, flexWrap: "wrap" }}>
            {OPCIONES.map((o) => {
              ...
              return (
                <button
                  key={o.value}
                  onClick={() => onResponder(codigo, o.value)}
                  style={{
